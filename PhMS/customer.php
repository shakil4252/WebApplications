...
session_start();
			if($_SESSION['custnam']!=""){
				$name=$_SESSION['custnam'];
				$mail=$_SESSION['custmail'];
				$pass=$_SESSION['custpass'];
			}
  ...
  <div class="content-wrapper">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="dist/img/.jpg" alt="User profile picture">
			  ...
			  <?php
				...
				$sql=$conn->query("SELECT `customer_id`,`customer_name`,`customer_mail`,`customer_pass` FROM `customer`
				WHERE `customer_name`='$name' and `customer_pass`='$pass' ");
				if($sql->rowCount()>0){
					$row = $sql->fetch(PDO::FETCH_ASSOC);
					$nam=$row["customer_name"];
					$id=$row["customer_id"];
					$contact=$row["customer_mail"];
			  ?>

              <h3 class="profile-username text-center"><?php echo $nam ?></h3>
