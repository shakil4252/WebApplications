...
<div class="wrapper">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Register a new supplier</p>

    <form action="supplier_outregpan.php" method="post">
    ...
    <a href="supplier_out_pass.php" class="text-center">I already have a membership</a>
  </div>
            <!-- /.box-body -->
          </div>
    <!-- /.content -->
