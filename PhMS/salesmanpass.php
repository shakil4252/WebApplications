...
<div class="wrapper">
  ...
  <div class="content-wrapper">
          ...
          <div class="box box-primary">
			<form class="phform" method="post" action="salesman.php">
				<table class="table">
					<tr>
						<td>
						...
						<td>
							<label for="">Salesman Password:</label>
    ...
    <p class="formreg">New <a href="salesmanreg.php" >Registrasion</a> as a salesman</p>
            <!-- /.box-body -->
          </div>
    <!-- /.content -->
  </div>
