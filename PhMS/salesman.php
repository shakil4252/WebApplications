<?php
session_start();
      if($_SESSION['salesmannam']!=""){
        $name=$_SESSION['salesmannam'];
        $mail=$_SESSION['salemail'];
        $pass=$_SESSION['salepass'];
      }
?>
<!DOCTYPE html>
<html>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="salesmanpass.php"><i class="fa fa-circle-o"></i>Salesman</a></li>
          </ul>
        </li>
		<li>
  ...
  <div class="content-wrapper">
          ...
          $pass=$_POST["id"];
				...
				$sql=$conn->query("SELECT `salesman_name`,`salesman_id`,`salesman_contact`,`password`,`salesman_salary`,`salesman_payment`
				FROM `salesman` WHERE `salesman_name`='$name' and `password`='$pass' ");
				if($sql->rowCount()>0){
					$row = $sql->fetch(PDO::FETCH_ASSOC);
					$nam=$row["salesman_name"];
					$id=$row["salesman_id"];
					$contact=$row["salesman_contact"];
					$add="Comilla";
					$salary=$row["salesman_salary"];
					$payment=$row["salesman_payment"];
          //$_SESSION
          $_SESSION['logername']=$name;
          $_SESSION['logerid']=$pass;

			  ?>

              <h4 class="text-center"><?php echo $nam ?></h4>
