...
<!-- /.sidebar -->
  ...
  <div class="content-wrapper">
		<div class="col-md-12 slipinput">
            <h3>Expense-outer</h3>
			<h4>Payment:</h4>
			<form action="expenses_out_sub.php" method="post">
			<table class="table table-bordered">
				<tr>
					<td>
              <label for="">Supplier:</label>
              <input type="text" name="supplier"></td>
					<td>
              <label for="">Supplier-ID:</label>
              <input type="text" name="supplierid"></td>
				</tr>
				<tr>
					<td>
            ...
            <form action="expenses_out_pan.php" method="post">
              ...
              <table class="table table-bordered">
                <tr class="sliptr">
					...
					<td>
					  ...
					  <input id="hero-demo" name="product_id" type="text">
					</td>
                </tr>
				<tr class="sliptr">
					<td>
				  ...
				  <select name="packetFMT" id="packet">
				  	<option value="0">packet</option>
				  	<option value="1">1</option>
				  	<option value="2">2</option>
				  	<option value="3">3</option>
				...
				<tr class="sliptr">
					...
					<td>
						<label  for="">Unit-MRP:</label>
						<input type="text" name="mrp" id="price">
						<select name="mrpFMT" id="">
							<option value="1">piece</option>
							<option value="2">set</option>
							<option value="3">packet</option>
							<option value="4">box</option>
                ...
                <tr class="sliptr">
					...
					<td>
					  ...
					  <select  name="product_type" id="">
					  	...
					  	<option value="cometics">cometics</option>
					  </select>
					</td>
                </tr>
				<tr>
			...
			<table class="table table-bordered rowBorder">
				...
				<tr>
					...
					<td><?php echo $_SESSION['box_'][$n].";  ".$_SESSION['packet_'][$n].";  ".$_SESSION['set_'][$n].";  ".$_SESSION['piece_'][$n];?></td>
