  ...
  <div class="content-wrapper">
          ...
          <div class="box box-primary">
			...
			<?php
				...
				$sql=$conn->query("select product.product_name,product.product_id,product_count.expire_date,product_count.count_no
				from product inner join product_count on product.product_id=product_count.product_id where expire_date like '___$m-$y' ;");
				if($sql->rowCount()>0){
			?>	
					<table class="table table-bordered rowBorder">
						 <h3 class="profile-username text-center">Expired Product</h3>
						<tr>
							<td class="bold">Product <br>count</td>
							<td class="bold">Product</td>
							<td class="bold">Product ID</td>
							<td class="bold">Expired Date</td>
						</tr>
					<?php
