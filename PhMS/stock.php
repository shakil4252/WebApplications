  ...
  <div class="content-wrapper">
          ...
          <div class="box box-primary">
			...
			<?php
				...
				product_count inner join product on product.product_id=product_count.product_id order by product.product_name ;");
				if($sql->rowCount()>0){
			?>	
					<table class="table table-bordered rowBorder">
						 <h3 class="profile-username text-center">Product Stock</h3>
						<tr>
