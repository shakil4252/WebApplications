...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="#">
             <i class="fa fa-product-hunt"></i> <span>Customer</span>
            <span class="pull-right-container">
            
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i>Slip</a></li>
      ...
      <i class="fa fa-users" aria-hidden="true"></i>
          ...
          <ul class="treeview-menu">
            <li class=""><a href="#"><i class="fa fa-circle-o"></i>Show Stock</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>Expired Product</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>Zero Stock</a></li>
          </ul>
        </li>
        <li>
      ...
      <span>Expenses</span>
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>Company Product</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>Outer Product</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>Other Expenses</a></li>
          </ul>
        </li>
        </li>
        <li class="treeview">
      ...
      <span>Suppliers</span>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i>Outer</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Register a new salesman</p>

    <form action="salesmanregpan.php" method="post">
      <div class="form-group has-feedback">
        <input name="nam" type="text" class="form-control" placeholder="Full name">
    ...
    <a href="salesmanpass.php" class="text-center">I already have a membership</a>
  </div>
            <!-- /.box-body -->
          </div>
    <!-- /.content -->
