  ...
  <div class="content-wrapper">
          ...
          <div class="box box-primary">
			...
			<?php
				...
				$sql=$conn->query("SELECT sum(sale_payment) FROM sales WHERE sale_date like '___$m-$y' ;");
				$xsql=$conn->query("SELECT sum(expense_payment) FROM expenses WHERE expense_date like '___$m-$y' ;");
				if($xsql->rowCount()>0){
			...
			<hr>
				<table class="table table-bordered rowBorder">
						 <h3 class="profile-username text-center">Monthly Transiction</h3>
					<tr>
						<td>Month</td>
						<td><?php echo $date?></td>
					</tr>
				...
				from sales where sale_date like '___$m-$y' group by sale_date");
          ...
          <hr>
				...
				FROM `expenses` WHERE expense_date like '___$m-$y' group by expense_date");
